...
function ability.crit(options)
    ...
    event.trigger(sourceUnit, EVENT.Unit.CritAbility, { triggerUnit = sourceUnit, targetUnit = targetUnit })
    event.trigger(targetUnit, EVENT.Unit.Be.CritAbility, { triggerUnit = targetUnit, sourceUnit = sourceUnit })
