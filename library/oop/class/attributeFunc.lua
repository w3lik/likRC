...
---@param modify number
---@return self|number
function class:punish(modify)
    return self:prop("punish", modify)
end

--- 硬直[当前]
---@param modify number
---@return self|number
function class:punishCur(modify)
    return self:prop("punishCur", modify)
end

--- 硬直[恢复]
---@param modify number
---@return self|number
function class:punishRegen(modify)
    return self:prop("punishRegen", modify)
end
...
---@param modify number
---@return self|number
function class:weight(modify)
    return self:prop("weight", modify)
end

--- 负重[当前]
---@param modify number
---@return self|number
function class:weightCur(modify)
    return self:prop("weightCur", modify)
end
