    ...
    if (obj._id ~= nil) then
        local un = function()
            ...
            if (obj._handle ~= nil) then
                ...
                elseif (isClass(obj, DestructableClass)) then
                    J.SetDestructableInvulnerable(obj._handle, true)
                    J.RemoveDestructable(obj._handle)
                ...
                elseif (isClass(obj, EffectClass)) then
                    japi.EXSetEffectSize(obj._handle, 0.01)
